      ...
      <Routes>
        <Route path='/' element={<Layout />}>
          ...
          <Route path='medicine' element={<MedicineView />}>
            ...
            <Route path='history' element={<MedicineHistoryView />} />
            <Route path='family' element={<MedicineFamilyView />} />
            <Route path='products' element={<MedicineProductsView />} />
            <Route path='products/:name' element={<MedicineDetailView />} />
            <Route path='location' element={<MedicineLocationView />} />
            <Route path='ingredients' element={<MedicineIngredientsView />} />
          </Route>
